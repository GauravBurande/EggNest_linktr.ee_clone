    ...
    return (
        <div>
            <div className='w-full h-[100vh] flex flex-col items-center justify-center'>
                ...
                <div className='py-12 px-12 mt-5 w-1/2 mx-auto bg-gray-800 rounded-md shadow-lg'>
                    <div className='flex flex-col items-center justify-center'>
                        <h3 className='py-3 text-yellow-100 uppercase'>title</h3>
                        ...
                        <h3 className='py-3 text-yellow-100 uppercase'>link</h3>
                        <input className='w-full focus:scale-x-105 transition-transform duration-200 outline-none p-2 text-lg bg-gray-700' type="text" />
                    </div>
                </div>
            </div>
